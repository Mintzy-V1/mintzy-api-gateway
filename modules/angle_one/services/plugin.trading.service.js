...
import { forwardToPlugin, getTargetBaseUrlByApiKey, shouldAutoAuthenticateApiKey } from "./plugin.proxy.service.js";
import * as dataService from "./plugin.data.service.js";
import AppError from "../utils/AppError.js";
import logger from "../config/logger.js";

const AUTO_AUTH_PLUGIN_BASE_URL = 'http://32.198.166.49:8000';
...
const submitCredentials = async (userId, payload) => {
    ...
    console.log("insdie the submit credentials service ")
